...
def getLLamaresponse(input_text,no_words,blog_style):
    ...
    ### LLama 2 model
    llm=CTransformers(model='/Users/sarahasad/Desktop/Blog Generation App/models/llama-2-7b-chat.ggmlv3.q8_0.bin',
                      model_type='llama',
    ...
    template="""
        Write a blog for {blog_style} profile on the topic {input_text} 
    ...
    ## Generate the responses from LLama 2 model which is from GGML
